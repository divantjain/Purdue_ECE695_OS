...
// Num physical pages 
#define MEM_NUM_PHY_PAGES ((MEM_MAX_SIZE + 0x1) >> MEM_L1FIELD_FIRST_BITNUM)
...
#define MEM_HEAP_MAX_MEM (MEM_PAGESIZE)
#define MEM_HEAP_ORDER_0_SIZE (32)
#define MEM_HEAP_MAX_ORDER_0_BLOCKS (MEM_HEAP_MAX_MEM / MEM_HEAP_ORDER_0_SIZE)
#define MEM_HEAP_MAX_ORDER (7) // Max Order is "Antilog(base 2) of (MEM_HEAP_MAX_MEM/MEM_HEAP_ORDER_0_SIZE)"
#define MEM_HEAP_TREE_MAX_ELEM (255) // ((CalculatePower(2, (MEM_HEAP_MAX_ORDER + 1))) - 1)
