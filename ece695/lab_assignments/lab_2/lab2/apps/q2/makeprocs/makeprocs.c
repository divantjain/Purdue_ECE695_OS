...
void main (int argc, char *argv[])
{
  ...
  for(i=0; i<numprocs; i++) {
    ...
    process_create(PRODUCER_FILENAME_TO_RUN, h_mem_str, s_procs_completed_str, buffer_access_lock_str, NULL);
    process_create(CONSUMER_FILENAME_TO_RUN, h_mem_str, s_procs_completed_str, buffer_access_lock_str, NULL);
